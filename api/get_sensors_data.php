...
// ✅ Lấy sensor data từ esp_data (SỬA LỖI CỘT value1 -> temp, value2 -> hum)
$sql2 = "SELECT sensor, location, device_id, temperature, humidity, light, gas, reading_time 
FROM SensorData 
...
while ($row = $result2->fetch_assoc()) {
    // ✅ Ghi log dữ liệu cảm biến để kiểm tra
    error_log("Sensor Data: " . json_encode($row));

    // ✅ Bỏ qua dữ liệu nếu null hoặc không hợp lệ
